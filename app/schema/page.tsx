          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-6 shadow-sm border">
              ...
              <div className="text-xs text-gray-600 space-y-2">
                ...
                <p>
                  После подписания договора, вам будет выдан доступ к CRM
                  системе в которой вы будете видеть все этапы работы с вами, от
                  подбора авто, до его отгрузки и выдачи вам в вашем городе,
                  получать подробный фото и видео отчет, а так же осуществлять
                  общение со своим менеджером.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border">
              ...
              <div className="text-xs text-gray-600 space-y-2">
                ...
                <p>
                  Результаты осмотра будут отображаться в вашем личном кабинете
                  в CRM системе.
                </p>
                <p>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border">
              ...
              <div className="text-xs text-gray-600 space-y-2">
                ...
                <p>Платежи поступают в Корею мгновенно</p>
              </div>
            </div>
